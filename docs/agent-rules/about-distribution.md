# Distribution and About Screen Rules

Read this file when the task touches installation instructions, distribution notes, About screen, licensing text, or end-user run instructions.
